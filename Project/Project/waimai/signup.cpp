    ...
    ui(new Ui::Signup)
{
    ...
    ui->username->setPlaceholderText("Cant be pure numbers");
...
void Signup::on_signup_clicked()
{
    ...
    if(ui->password->text()==ui->ensure_password->text()&&ui->password->text()!=NULL&&ui->username->text()!=NULL)
    {
        ...
        else
        {
            ...
            if(ui->checktype->isChecked())
            {
                ...
                {
                    QMessageBox::information(this,NULL,"Register successfully");
    ...
    {
        QMessageBox::warning(this,"Warning","please enter pwd");
        ui->username->clear();
        ui->password->clear();
        ui->ensure_password->clear();
        ui->username->setFocus();
    ...
    {
        QMessageBox::warning(this,"Warning","please confirm pwd");
        ui->username->clear();
        ui->password->clear();
        ui->ensure_password->clear();
        ui->username->setFocus();
    ...
    {
        QMessageBox::warning(this,"Warning","not consistent");
        ui->username->clear();
        ui->password->clear();
        ui->ensure_password->clear();
        ui->username->setFocus();
